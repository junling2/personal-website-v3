<template>
  <section class="blog">
    <div class="py-8 md:py-16 text-center">
      <h1 class="text-lg md:text-xl lg:text-4xl xl:text-6xl">Leetcode Solutions</h1>
      <h2 class="text-base md:text-lg lg:text-xl xl:text-2xl">
        Posts documenting thought process and analysis for Data Structure and Algorithm problems.
      </h2>
    </div>
